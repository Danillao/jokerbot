const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  const textpremERROR = `*[❗𝐈𝐍𝐅𝐎❗] INSIRA  A @𝚝𝚊𝚐 𝙳𝙰 𝙿𝙴S𝚂𝙾𝙰 𝙾U 𝚁𝙴𝚂𝙿𝙾𝙽𝙳𝙰 𝙰 𝙰𝙻𝙶𝚄MA 𝙼𝙴𝙽𝚂𝙰GEM 𝙳𝙰 𝙿𝙴S𝚂𝙾𝙰 𝚀𝚄𝙴 𝙳𝙴𝚂𝙴JA ADICIONAR A LISTA DE 𝚄𝚂𝚄𝙰𝚁𝙸𝙾𝚂 𝙿𝚁𝙴𝙼𝙸𝚄𝙼*\n\n*—◉ 𝙴X𝙴𝙼𝙿𝙻𝙾:*\n*◉ ${usedPrefix + command} @${m.sender.split`@`[0]} 1*\n*◉ ${usedPrefix + command} 1 <responder a mensagem>*`;
  ...
  const ERROR = `*[❗] O 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 ${'@' + who.split`@`[0]} 𝙽Ã𝙾 𝚂𝙴 𝙴𝙽𝙲𝙾𝙽𝚃𝚁𝙰 𝙴M 𝙼𝙸NHA 𝙱𝙰𝚂𝙴 𝙳𝙴 𝙳𝙰D𝙾𝚂*`;
  ...
  if (command == 'addprem' || command == 'userpremium') {
    ...
    const textprem1 = `*🎟️ 𝙽O𝚅𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!!!*\n\n*✨ 𝚄𝚂𝚄𝙰𝚁𝙸𝙾: ${name}*\n*🕐 𝚃𝙴𝙼𝙿𝙾: ${txt} hora(s)*\n*📉 𝚁𝙴𝚂𝚃𝙰𝙽𝚃𝙴: ${timeLeft} segundos*`;
  ...
  if (command == 'addprem2' || command == 'userpremium2') {
    ...
    const textprem2 = `*🎟️ 𝙽O𝚅𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!!!*\n\n*✨ 𝚄𝚂𝚄𝙰𝚁𝙸𝙾: ${name}*\n*🕐 TEMPO: ${txt} día(s)*\n*📉 𝚁𝙴𝚂𝚃𝙰𝙽𝚃𝙴: ${timeLeft} horas*`;
  ...
  if (command == 'addprem3' || command == 'userpremium3') {
    ...
    formatTime(user.premiumTime - now).then((timeleft) => {
      const textprem3 = `*🎟️ 𝙽O𝚅𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!!!*\n\n*✨ 𝚄𝚂𝚄𝙰𝚁𝙸𝙾: ${name}*\n*🕐 TEMPO: ${txt} semana(s)*\n*📉 𝚁𝙴𝚂𝚃𝙰𝙽𝚃𝙴: ${timeleft}*`;
  ...
  if (command == 'addprem4' || command == 'userpremium4') {
    ...
    user.premium = true;
    formatTime(user.premiumTime - now).then((timeleft) => {
      const textprem4 = `*🎟️ 𝙽O𝚅𝙾 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!!!*\n\n*✨ 𝚄𝚂𝚄𝙰𝚁𝙸𝙾: ${name}*\n*🕐 TEMPO: ${txt} mes(es)*\n*📉 𝚁𝙴𝚂𝚃𝙰𝙽𝚃𝙴: ${timeleft}*`;
