...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] NOME DA CANÇÃO, 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 INSIRA O COMANDO 𝙼𝙰I𝚂 O NOME/𝚃𝙸𝚃𝚄𝙻𝙾 𝙳𝙴 𝙰𝙻𝙶𝚄M𝙰 CANÇÃO QUE SEJA 𝚅𝙸𝙳𝙴𝙾 𝙳O 𝚈𝙾𝚄𝚃𝚄𝙱𝙴 EXEMPLO:*\n*${usedPrefix + command} Good Feeling - Flo Rida* `;
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            await conn.reply(m.chat, '*[❗] 𝙴𝚁𝚁𝙾𝚁 𝙽ÃO FOI POSSIVEL BAIXAR O AUDIO*', m);
          }
        }
      }
    }
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            await conn.sendMessage(m.chat, {document: {url: n2}, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `▢ 𝚃𝙸𝚃𝚄𝙻𝙾: ${n}\n▢ 𝙿𝙴𝚂𝙾 𝙳O 𝚅𝙸𝙳𝙴𝙾: ${n3}`, thumbnail: await fetch(n4)}, {quoted: m});
          } catch {
            await conn.reply(m.chat, '*[❗] 𝙴𝚁𝚁𝙾𝚁 𝙽ÃO FOI POSSIVEL BAIXAR O VIDEO*', m);
          }
        }
      }
    }
