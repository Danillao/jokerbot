...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*[❗] EXEMPLO 𝙳𝙴 𝚄𝚂𝙾 𝙳O 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 ${usedPrefix + command}* https://getstickerpack.com/stickers/flork-memes-4-1`;
  try {
    const url = text;
    ...
    await m.reply('*[❗] 𝙴𝚁𝚁𝙾𝚁, 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁 TENTE NOVAMENTE MAIS TARDE*');
  }
};
