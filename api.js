...
global.rpg = {
  emoticon(string) {
    ...
    const emot = {
      ...
      mana: '🪄 Hechizo',
      agility: '🤸‍♂️ Agilidade',
      darkcrystal: '♠️ Cristal Negro',
      iron: '⛓️ Ferro',
      rock: '🪨 Rocha',
      potion: '🥤 Poção',
      superior: '💼 Superior',
      robo: '🚔 Roubo',
      upgrader: '🧰 Aumentar Melhorias',
      wood: '🪵 Madeira',
      strength: '🦹‍ ♀️ Força',
      arc: '🏹 Arco',
      armor: '🥼 Armadura',
      ...
      sword: '⚔️ Espada',
      common: '📦 Caixa Comum',
      uncoommon: '🥡 Caixa Pouco Común',
      mythic: '🗳️ Caixa Mística',
      ...
      bibitjeruk: '🍊 Sementess de Laranja',
      bibitmangga: '🥭 Sementes de Manga',
      bibitpisang: '🍌 Sementess de Banana',
      ayam: '🐓 Pollo',
      babi: '🐖 Puerco',
      Jabali: '🐗 Jabali',
      bull: '🐃 Toro',
